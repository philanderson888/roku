' import the whole row and the index of the video to play
sub ShowVideoScreen(content as Object, itemIndex as Integer)
    ...
    ' if the index is non-zero then we clone the subset of items and make 
    ' that the new node using node.Update({children:clone})
